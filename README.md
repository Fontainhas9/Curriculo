...
Este repositório contém o código-fonte do meu currículo/portfólio profissional online, disponível em fontainhas9.github.io/Curriculo/. O projeto apresenta a minha trajetória como Programador de Software e Analista de Dados, detalhando a minha experiência profissional, projetos, publicações e certificações.
...
Design Responsivo: O style.css utiliza clamp() para tipografia fluida e uma layout baseado em Flexbox/Grid, assegurando uma boa experiência em qualquer dispositivo.
...
"Needs and Requirements Assessment of Physical Product Traceability within the Portuguese Textile and Clothing Industry" — CENTERIS 2026 (Elsevier).

"Centralized Kalman Filters to Enhance Localization Accuracy Within Vehicular Networks Context" — Innovations in Mechatronics Engineering IV 2025 (Springer).
...
👉 https://fontainhas9.github.io/Curriculo/
